...
import me.musclegeeker.filter.GithubAuthenticationFilter;
import me.musclegeeker.filter.QQAuthenticationFilter;
import me.musclegeeker.filter.qq.GithubAuthenticationManager;
import me.musclegeeker.filter.qq.QQAuthenticationManager;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .logout()
                .permitAll()
                .and().portMapper().http(8080).mapsTo(443)
                .and().csrf().disable();
